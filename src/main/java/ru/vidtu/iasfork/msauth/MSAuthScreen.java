...
public class MSAuthScreen extends GuiScreen {
	...
	public void setState(String s) {
		...
		mc.addScheduledTask(() -> this.text = mc.fontRendererObj.listFormattedStringToWidth(I18n.format(s), width));
	}
	
	public void error(String error) {
		Minecraft mc = Minecraft.getMinecraft();
		mc.addScheduledTask(() -> {
			this.text = mc.fontRendererObj.listFormattedStringToWidth(EnumChatFormatting.RED + I18n.format("ias.msauth.error", error), width);
			endTask = true;
		});
	}
}
