...
public class GuiAccountSelector extends Screen {
	...
	public void render(int mx, int my, float delta) {
		...
		if (!queriedaccounts.isEmpty()) {
			...
			if (queriedaccounts.get(selectedAccountIndex) instanceof ExtendedAccountData) {
				...
				if (ead.premium != null) {
					if (ead.premium) this.drawString(font, I18n.format("ias.premium"), width - 8 - 61, height / 2 - 64 - 13, 6618980);
				...
				this.drawString(font, I18n.format("ias.premium"), width - 8 - 61, height / 2 - 64 - 13, 6618980);
			}
		}
	}
	 ...
	 */
	private void add() {
		minecraft.displayGuiScreen(new GuiAddAccount(this));
	}
	 ...
	 */
	private void edit() {
		minecraft.displayGuiScreen(new GuiEditAccount(this, selectedAccountIndex));
	}
